...
- **Inyección de dependencias:** Uso del contenedor nativo de .NET
...
{
  "ConnectionStrings": {
    "DefaultConnection": "Data Source=ApiGestionPersonal.db",
    "ProductionConnection": "Server=.;Database=ApiGestionPersonal;Trusted_Connection=True"
  }
}
```
...
```json
{
  "Jwt": {
    ...
    "Issuer": "ApiGestionPersonal",
    "Audience": "ApiGestionPersonal",
    "ExpiresInMinutes": 60
  }
}
```
...
**Osunita** - Desarrollador Full-Stack
